...
def test_is_included():
    for version, data in [
        (
            "1.0a1",
            [("alpha 1", True), ("alpha 2", False), ("beta 1", False), ("rc 2", False)],
        ),
        (
            "1.0a2",
            [("alpha 1", True), ("alpha 2", True), ("beta 1", False), ("rc 2", False)],
        ),
        (
            "1.0b2",
            [("alpha 1", True), ("alpha 2", True), ("beta 1", True), ("rc 2", False)],
        ),
        (
            "1.0rc2",
            [("alpha 1", True), ("alpha 2", True), ("beta 1", True), ("rc 2", True)],
        ),
        (
            "1.0",
            [("alpha 1", True), ("alpha 2", True), ("beta 1", True), ("rc 2", True)],
